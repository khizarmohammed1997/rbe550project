...
(cl:in-package gopher_move_it_config-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Joints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gopher_move_it_config-msg:<Joints> is deprecated: use gopher_move_it_config-msg:Joints instead.")))

(cl:ensure-generic-function 'joints-val :lambda-list '(m))
(cl:defmethod joints-val ((m <Joints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gopher_move_it_config-msg:joints-val is deprecated.  Use gopher_move_it_config-msg:joints instead.")
  (joints m))
